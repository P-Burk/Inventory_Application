...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //removes item from inventory DB
    ...
    //used for getting a user's phone number
    ...
    //updates the user's SMS flag.
    //used when the user wants to turn on/off SMS messages generated by the app
    ...
    //returns the user's SMS flag status
